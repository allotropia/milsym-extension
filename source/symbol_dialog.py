...
def open_symbol_dialog(ctx, model, controller, sidebar_panel, selected_shape, selected_node_value):
    ...
    try:
        handler = SymbolDialogHandler(ctx, model, controller, None, sidebar_panel, selected_shape, selected_node_value)
